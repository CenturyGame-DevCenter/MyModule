...
namespace CenturyGame.Framework.Network
{
    public class HttpAgent
    {
        ...
        public void Post(string url, byte[] postData, IDictionary<string, string> header, Action<byte[]> callback)
        {
        ...
        public void Get(string url, IDictionary<string, string> args, IDictionary<string, string> header, Action<byte[]> callback)
        {
